...
The file stats19_bayesnet_2.R is primarily reading in the data, cleaning, and categorizing it. Also, the arcs for the Bayesian Network are defined therein.
